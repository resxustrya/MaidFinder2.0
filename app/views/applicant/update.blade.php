                            ...
                            <div class="valign-wrapper">
                                ...
                                <select name="nationality" class="browser-default tab1">
                                    ...
                                    @foreach($nationality as $n)
                                        <option {{ (isset($app->nationality) and $app->nationality == $n->id) ? 'selected' : '' }} value="{{ $n->id }}">{{ $n->nationality }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="valign-wrapper">
                                ...
                                <select name="religion" class="browser-default tab1">
                                    ...
                                    @foreach($religion as $n)
                                        <option {{ (isset($app->religion) and $app->religion == $n->id) ? 'selected' : '' }} value="{{ $n->id }}">{{ $n->religion }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m12 l12">
                                <p class="center-align">
                                    <button class="btn-large waves-effect blue" type="submit" name="action">Update profile
