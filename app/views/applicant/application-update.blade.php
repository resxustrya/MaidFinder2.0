                    ...
                    <form action="{{ asset('/applicant/job/application/edit') }}" method="POST">
                        ...
                        <div class="row">
                            <p class="grey-text">
                                ...
                                <textarea name="pitch"  placeholder ="Tell the employer why you are best suited for this role. Highlight specific skills and how you can contribute." style="height: 150px;" cols="20">{{ $application->pitch != null ? $application->pitch : '' }}</textarea>
