                    ...
                    <div class="row">
                        ...
                        <div class="col s12 m12 l9">
                            ...
                            <span class="valign-wrapper">
                                ...
                                <strong class="col l8">{{ $emp->contactno }}</strong>
                            </span>
                            <br />
                            <span class="valign-wrapper">
                                <i class="material-icons">email</i><span>Email :</span>
                                <strong class="col l8">{{ $emp->email }}</strong>
                            </span>
                            <br>
                            <div class="col l12">
                                <a class="col l9 btn green" href="{{ asset('/employer/update') }}">Edit Profile</a>
                            </div>
                        </div>
                    </div>
                </div>
